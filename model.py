...
class NewUNetModule(nn.Module):
    ...
    def forward_features(self, feats_rgb, feats_a, feats_av):
        ...
        f0_0 = self.Asy_fusion1(feats_rgb[0], feats_a[1], feats_av[1])
        f1_0 = self.Asy_fusion2(feats_rgb[1], feats_a[2], feats_av[2])
        f2_0 = self.Asy_fusion3(feats_rgb[2], feats_a[3], feats_av[3])
        f3_0 = self.Asy_fusion4(feats_rgb[3], feats_a[4], feats_av[4])
